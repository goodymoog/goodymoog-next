        ...
        <div className="content">
          ...
          <div className="main-content">
            ...
            >
              ...
              <span style={{ opacity: 0.55 }}>Sep 2026</span>
            </h2>
            <SpinningAlbumVideo />
...
{/* 
            ...
            >
              ...
              <span style={{ opacity: 0.55 }}>Jun 2025</span>
            </h2>
            <div className="album-box">
              <p>
            ...
            >
              ...
              <span style={{ opacity: 0.55 }}>Nov 2024</span>
            </h2>
            <div className="album-box">
              <p>
          ...
          <aside className="sidebar">
            ...
            <ul className="sidebar-list">
              ...
              <li><a href="https://www.youtube.com/watch?v=HqqtfCA40_4" target="_blank" rel="noreferrer">Video 3</a></li>
